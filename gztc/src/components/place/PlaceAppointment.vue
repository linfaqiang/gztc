<template>
  <div class="mra-box">
    <!--头部-->
    <sub-header title="场地预定"></sub-header>
      ...
      <div class="com-form">
        <dl>
          <dd>
            ...
            <input type="text" name="" v-model="aDate" :formatter="formatter" placeholder="请选择" readonly="true" onfocus="this.blur()" @click="showDataPicker">
          </dd>
          <dd>
            <label>
              <span>*</span>
        ...
        if (res.data.success) {
          ...
          that.$router.push({
            ...
            query: {
              ...
              orderId: result.id,
              orderType: '2',
              payOptionName: that.meetingRoom.name + '(场地预定)',
