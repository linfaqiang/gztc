  ...
  <div class="details-project-page">
    ...
    <div class="details-content">
      <div class="img-item">
        <van-swipe :autoplay="6000">
          <van-swipe-item><img src="static/img/recomment/project.jpg" alt=""></van-swipe-item>
          <van-swipe-item><img src="static/img/recomment/project.jpg" alt=""></van-swipe-item>
          <van-swipe-item><img src="static/img/recomment/project.jpg" alt=""></van-swipe-item>
          <van-swipe-item><img src="static/img/recomment/project.jpg" alt=""></van-swipe-item>
        </van-swipe>
      ...
      <div class="content-item">
        ...
        <dl class="address-list">
          ...
          <dt>
            ...
            <p class="remarks-text" v-html="recommend.remark"></p>
          </dt>
        </dl>
      </div>
      <div class="details-tab">
        ...
        <div class="matching-item">
          ...
          <h3>配套</h3>
          <br/>
          <p><img src="static/img/recomment/img1.jpg" alt=""></p>
          <br/>
          <p>内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍内容介绍</p>
          <br/>
        </div>
      </div>
    </div>
    <div class="footer-item">
      <dl>
        ...
        <dt><button type="button">预约看房</button></dt>
      </dl>
    </div>
  </div>
</template>
...
export default {
  ...
  created () {
    getRecommend({aid: 6, type: 1}).then((res) => {
      console.log(res)
      this.recommend = res.data.result
    }).catch((err) => {
      console.log(err.message)
    })
    getHouseType({aid: 6}).then((res) => {
